...
def test_frontend_and_manifest_use_rewrite_version():
    ...
    assert "BILLY_FRONTEND_VERSION = '0.6.4'" in bootstrap
    assert "BILL_TRACKER_VERSION = '0.6.4'" in implementation
    assert "./bill-tracker-i18n.js?v=0.6.4" in implementation
